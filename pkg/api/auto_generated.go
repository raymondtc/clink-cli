...
// ListCdrObs - 查询外呼通话记录
func (a *GeneratedAPI) ListCdrObs(ctx context.Context, phone string, agent string) (interface{}, error) {
	// 构建请求参数
...
// ListCdrIbs - 查询呼入通话记录
func (a *GeneratedAPI) ListCdrIbs(ctx context.Context, phone string, agent string) (interface{}, error) {
	// 构建请求参数
...
// ListQueues - 查询队列列表
func (a *GeneratedAPI) ListQueues(ctx context.Context) (interface{}, error) {
	// 构建请求参数
